...
# life_v4.0.py : life game with pygame with NON-LOCAL update for the CA
...
# versione con aggiornamento del valore della cellula in base ai valori di cellule non locali
...
def rndVectors(v,length):
	# creates a random vectors of coordinates
	for i,j in itertools.product(range(len(v[0])),range(len(v[1]))):
		w = []
		# print(m)
